...
function fallbackSha256(data: ArrayBuffer): string {
...
export async function sha256Hex(data: ArrayBuffer, subtle: SubtleCrypto | null = globalThis.crypto?.subtle ?? null): Promise<string> {
  if (!subtle) return fallbackSha256(data)
