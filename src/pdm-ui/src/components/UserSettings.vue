...
.user-form { display: grid; gap: 14px; }.user-form label { display: grid; gap: 7px; color: var(--pdm-text-soft); font-size: 12px; }.user-form input:not([type='checkbox']), .user-form select { min-height: 38px; border: 1px solid #d7dee9; border-radius: 6px; padding: 0 10px; background: #fff; }.user-form input:disabled { background: #f4f6f9; color: var(--pdm-muted); }.user-form small { color: var(--pdm-muted); line-height: 1.4; }.user-form .user-checkbox { display: flex; align-items: center; gap: 8px; }
