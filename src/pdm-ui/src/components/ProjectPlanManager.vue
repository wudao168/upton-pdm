...
.pdm-gantt-cell-edit{text-align:center!important}.pdm-gantt-inline-editor{text-align:left;white-space:normal}.pdm-gantt-inline-editor.is-actual-finish{left:376px;width:290px}.pdm-gantt-inline-editor label{display:block;margin-bottom:8px}.pdm-gantt-inline-editor small{display:block;line-height:1.5}
