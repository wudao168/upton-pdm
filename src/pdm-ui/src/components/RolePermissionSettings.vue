...
.pdm-role-overview label { display: grid; gap: 6px; color: #435066; font-size: 13px; }.pdm-role-overview input,.pdm-role-overview select { box-sizing: border-box; width: 100%; height: 38px; border: 1px solid #d7dee9; border-radius: 5px; padding: 0 11px; background: #fff; color: var(--pdm-text); font: inherit; }.pdm-role-overview input[readonly] { background: #fbfcfe; color: #55657a; }
...
.pdm-permission-sidebar { border-right: 1px solid var(--pdm-border); background: #f8fafc; }.pdm-permission-sidebar > strong { display: block; padding: 13px 14px 9px; color: #64748b; font-size: 12px; font-weight: 600; }.pdm-permission-sidebar button { display: flex; width: 100%; min-height: 40px; align-items: center; justify-content: space-between; gap: 8px; border: 0; border-left: 3px solid transparent; padding: 8px 12px 8px 11px; background: transparent; color: #334155; cursor: pointer; font-size: 13px; text-align: left; }.pdm-permission-sidebar button:hover { background: #eef4fa; }.pdm-permission-sidebar button.is-active { border-left-color: var(--pdm-theme-accent); background: #eaf6f4; color: var(--pdm-theme-accent); font-weight: 600; }.pdm-permission-sidebar button small { min-width: 22px; border-radius: 10px; padding: 1px 6px; background: #e7edf4; color: #64748b; font-size: 10px; text-align: center; }.pdm-permission-sidebar button.is-active small { background: #d4eee9; color: #087f70; }
.pdm-permission-matrix { min-width: 0; min-height: 230px; padding-left: 14px; }.pdm-permission-matrix > header { display: flex; align-items: center; justify-content: space-between; padding: 12px 10px 9px 0; }.pdm-permission-matrix h3 { margin: 0; font-size: 15px; }.pdm-permission-matrix header div { display: flex; gap: 18px; }.pdm-permission-matrix header button { border: 0; padding: 2px 0; background: transparent; color: #355476; cursor: pointer; font-size: 12px; }
.pdm-permission-table-wrap { overflow: auto; border: 1px solid var(--pdm-border); }.pdm-permission-table-wrap table { width: 100%; min-width: 920px; border-collapse: collapse; table-layout: fixed; }.pdm-permission-table-wrap th { height: 38px; border-right: 1px solid var(--pdm-border); background: #f4f7fb; color: #42536a; font-size: 12px; font-weight: 600; text-align: left; }.pdm-permission-table-wrap th,.pdm-permission-table-wrap td { padding: 8px 10px; vertical-align: top; }.pdm-permission-table-wrap td,.pdm-permission-category-cell { height: 150px; border-top: 1px solid var(--pdm-border); border-right: 1px solid var(--pdm-border); }.pdm-permission-table-wrap th:last-child,.pdm-permission-table-wrap td:last-child { border-right: 0; }.pdm-permission-category-heading,.pdm-permission-category-cell { width: 92px; }.pdm-permission-category-cell { background: #fff; color: #475569; font-size: 12px; font-weight: 500; text-align: left; }
.pdm-permission-cell { display: flex; gap: 8px; margin: -1px -2px 7px; border: 1px solid transparent; border-radius: 5px; padding: 8px; background: #fff; cursor: pointer; }.pdm-permission-cell:hover { border-color: #cbd8e8; background: #f8fbff; }.pdm-permission-cell.is-checked { border-color: #a9c8ee; background: #f3f8ff; }.pdm-permission-cell > input { margin: 3px 0 0; }.pdm-permission-cell > span { display: grid; min-width: 0; gap: 3px; }.pdm-permission-cell strong { color: #24364b; font-size: 12px; line-height: 1.45; }.pdm-permission-cell strong em { margin-left: 5px; border-radius: 3px; padding: 1px 4px; background: #fff1e8; color: #c75a16; font-size: 10px; font-style: normal; font-weight: 500; }.pdm-permission-cell small { color: var(--pdm-muted); font-size: 11px; line-height: 1.45; }.pdm-permission-cell code { overflow: hidden; color: #63758c; font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }.pdm-permission-empty { color: #a0acba; }
