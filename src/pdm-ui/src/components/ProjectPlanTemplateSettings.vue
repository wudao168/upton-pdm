...
.pdm-plan-template-settings p{color:var(--pdm-muted);font-size:12px;margin:6px 0;line-height:1.4}
.pdm-template-access{display:flex;align-items:end;gap:10px;flex-shrink:0}.pdm-template-access>label{display:flex;flex-direction:column;min-width:260px;gap:6px;font-size:12px}.pdm-template-access>span:not(.pdm-template-scope){flex:1;color:var(--pdm-muted);font-size:11px}.pdm-template-scope{align-self:center;padding:3px 8px;border-radius:10px;font-size:11px;white-space:nowrap}.pdm-template-scope.is-system{color:var(--plan-accent);background:var(--plan-accent-soft)}.pdm-template-scope.is-personal{color:var(--pdm-purple);background:#f3e8ff}
