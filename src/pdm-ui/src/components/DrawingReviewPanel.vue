...
<style scoped>
.drawing-review-panel{position:absolute;z-index:20;inset:0 0 0 auto;box-sizing:border-box;width:300px;min-width:0;min-height:0;height:100%;display:flex;flex-direction:column;overflow-x:hidden;overflow-y:auto;background:var(--pdm-surface);border-color:var(--pdm-border);box-shadow:-10px 0 28px rgba(15,23,42,.16)}
...
.drawing-review-panel__title{flex:0 1 auto;min-width:0}.drawing-review-panel__title span{color:var(--pdm-blue);font-size:9px;font-weight:700;letter-spacing:.12em}.drawing-review-panel__header h2{margin:2px 0 0;overflow:hidden;font-size:15px;font-weight:600;text-overflow:ellipsis;white-space:nowrap}
