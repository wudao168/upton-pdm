...
<template>
  <section class="pdm-panel pdm-manager-panel" aria-label="审计查询">
    <header class="pdm-manager-heading"><div><h2>审计查询</h2><p>查看、下载、恢复、存档、审批和发布操作均保留审计记录。</p></div><button type="button" class="pdm-secondary-action" @click="$emit('refresh')">刷新</button></header>
