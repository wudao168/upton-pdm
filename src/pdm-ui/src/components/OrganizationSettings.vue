...
.org-tree-node { min-width: 0; display: inline-flex; align-items: center; gap: 7px; }.org-tree-node > span:nth-child(2) { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.org-tree-node em { color: var(--pdm-danger); font-size: 10px; font-style: normal; }.org-tree-node em.is-manufacturing { color: var(--pdm-green); }
.org-node-kind { flex: 0 0 auto; min-width: 35px; padding: 2px 5px; border-radius: 4px; background: #eef3f9; color: var(--pdm-text-soft); font-size: 10px; text-align: center; }.org-node-kind.is-company { background: #e7f1ff; color: var(--pdm-blue); }.org-node-kind.is-BusinessDivision { background: #e6f7f2; color: var(--pdm-green); }.org-node-kind.is-Team { background: #fff3dc; color: var(--pdm-orange); }
