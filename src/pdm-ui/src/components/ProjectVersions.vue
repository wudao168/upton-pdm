...
<template>
  <section class="pdm-panel pdm-manager-panel" aria-label="项目版本">
    <header class="pdm-manager-heading"><div><h2>项目版本</h2><p>按图档汇总当前项目全部历史版本；历史版本只能只读查看、下载、对比或生成新的工作版本。</p></div><button type="button" class="pdm-secondary-action" :disabled="pending" @click="$emit('refresh')"><RefreshCw :size="15" />刷新</button></header>
