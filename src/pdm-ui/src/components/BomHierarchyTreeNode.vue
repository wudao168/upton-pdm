...
<style scoped>
.bom-tree-node__project{display:grid;grid-template-columns:22px minmax(0,1fr);align-items:stretch;border-radius:5px}.bom-tree-node__project.is-selected,.bom-tree-node__category.is-selected{background:var(--pdm-theme-accent-soft);color:var(--pdm-theme-accent)}.bom-tree-node__toggle,.bom-tree-node__select,.bom-tree-node__category{border:0;background:transparent;color:inherit;cursor:pointer}.bom-tree-node__toggle{padding:0}.bom-tree-node__select{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:6px;padding:6px;text-align:left}.bom-tree-node__select span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bom-tree-node__select small{font-size:11px;color:var(--pdm-muted)}.bom-tree-node__children{margin:0 0 0 10px;padding:0 0 0 12px;border-left:1px solid #dbe4ee;list-style:none}.bom-tree-node__category{display:block;width:100%;padding:5px 8px;text-align:left;border-radius:4px}
</style>
