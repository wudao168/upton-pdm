...
.procurement-tracking__empty-tip { position: static; transform: none; padding: 16px; line-height: 1.4; overflow-wrap: anywhere; }
.procurement-tracking :deep(td.el-table__cell.is-delivery-delay) { background: #fee2e2 !important; color: var(--pdm-danger); animation: procurement-delivery-delay 2s ease-in-out infinite; }
