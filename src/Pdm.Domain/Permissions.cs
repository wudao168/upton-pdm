...
public static class RolePermissionCatalog
{
    ...
    [
        ...
        new(PermissionCodes.ProjectDelete, "删除空项目", "项目管理", Sensitive: true),
        ...
        new(PermissionCodes.BomEdit, "维护和导入BOM", "项目内容"),
        ...
        new(PermissionCodes.CustomerSettingsManage, "配置CRM客户同步", "系统设置", "设置CRM连接并同步当前账号可见的客户基础信息。", Sensitive: true),
    ...
    [
        new(UserRole.Engineer, "工程师", "承担设计、图档、BOM及发布准备工作。"),
        new(UserRole.PlanningManager, "计划管理", "按所属公司分配项目执行事业部。"),
        new(UserRole.ProcessReviewer, "工艺审核", "处理分配给本人的工艺审核任务。"),
        new(UserRole.Approver, "批准人", "处理分配给本人的批准任务。"),
        new(UserRole.ProductionViewer, "生产查看", "按后续项目岗位或目录授权查看生产资料。"),
        new(UserRole.Administrator, "系统管理员", "固定拥有全部权限，防止系统管理锁死。", true)
    ];
